...
def add_basic_consonants(font):
    ...
    for datum in data:
        ...
        gl.addAnchorPoint("vowel_aa", "base", gl.width/2, 250);
        gl.addAnchorPoint("vowel_u", "base", gl.width/2, 250);
        gl.addAnchorPoint("vowel_uu", "base", gl.width/2, 250);
        gl.addAnchorPoint("vowel_ai", "base", gl.width/2, 250);
        gl.addAnchorPoint("no_vowel", "base", gl.width/2, 250);

        gl.addAnchorPoint("vowel_e", "base", gl.width/2, 750);
...
def add_vowel_u(font):
    ...
    gl.right_side_bearing = 0;
    gl.width = 0;
    gl.addAnchorPoint("vowel_u", "mark", 40, 250);

    gl = font["bhaataan_uq_raw"];
    gl.addReference("bhaataan_u_raw", psMat.translate(120, 0));
    gl.addReference("bhaataan_no_vowel_raw");
    gl.addAnchorPoint("vowel_u", "mark", 160, 250);
...
def add_vowel_aa(font):
    ...
    gl.right_side_bearing = 0;
    gl.width = 0;
    gl.addAnchorPoint("vowel_aa", "mark", 660, 250);

    gl = font["bhaataan_aaq_raw"];
    gl.addReference("bhaataan_aa_raw", psMat.translate(140, 0));
    gl.addReference("bhaataan_no_vowel_raw");
    gl.addAnchorPoint("vowel_aa", "mark", 800, 250);
...
def add_vowel_uu(font):
    ...
    gl.right_side_bearing = 0;
    gl.width = 0;
    gl.addAnchorPoint("vowel_uu", "mark", 710, 250);

    gl = font["bhaataan_uuq_raw"];
    gl.addReference("bhaataan_uu_raw", psMat.translate(100, 0));
    gl.addReference("bhaataan_no_vowel_raw");
    gl.addAnchorPoint("vowel_uu", "mark", 810, 250);
...
def add_vowel_ai(font):
    ...
    gl.addReference("bhaataan_ai_raw", psMat.translate(120, 0));
    gl.addReference("bhaataan_no_vowel_raw");
    gl.addAnchorPoint("vowel_ai", "mark", 255, 250);
...
def add_vowel_no(font):
    ...
    gl.right_side_bearing = 0;
    gl.width = 0;
    gl.addAnchorPoint("no_vowel", "mark", 80, 250);
...
def add_punctuations(font):
    ...
    gl.left_side_bearing = 10;
    gl.right_side_bearing = 10;
...
def add_kerning(font):
    ...
    font.addKerningClass("kerning1", "kerning1-1",
                         [consonants + consonants_with_o + ["bhaataan_i_raw", "bhaataan_au_raw", "bhaataan_ii_raw"]],
    ...
    for c in consonants + consonants_with_o + ["bhaataan_i_raw", "bhaataan_ii_raw", "bhaataan_au_raw"]:
        gl = font[c];
        gl.addPosSub("singlepos1-1", -120, 0, -120, 0);
...
def add_with_o_consonants(font):
    ...
    for consonant in consonants:
        ...
        gl = font[name];
        gl.addReference("bhaataan_o_raw");
        gl.addReference(consonant, psMat.translate(180,0));

        for anc in font[consonant].anchorPoints:
            if anc[0] == "no_vowel":
                gl.addAnchorPoint("no_vowel", "base", 180 + anc[2], 250);
                break;
